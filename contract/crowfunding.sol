...
contract Crowfund {
    ...
    event ProjectStarted(uint id, string name, address indexed creator, 
    ...
    function startProject(string memory _name, string memory _description, uint _goal, uint32 _startTime, uint32 _endTime) external {
        ...
        emit ProjectStarted(count,_name, msg.sender, _goal, _startTime, _endTime);
    }
    ...
    function getProject(uint _id) external  view returns (address, string memory, string memory, uint, uint, uint, uint, bool){
        Project memory project = projects[_id];
        return (project.creator, project.name, project.description, project.goal, project.pledgedFunds, project.startTime, project.endTime, project.claimed);
    }
    ...
    function getProjects() public view returns (Project[] memory){
        Project[] memory ret = new Project[](count);
